...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_for_string() {
    let exp = json!({"name": "{...}"});
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_for_array() {
    let exp = json!({"people": "{...}"});
    let expected = Data::json(exp);
    let actual = json!({
        "people": [
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_for_obj() {
    let exp = json!({"people": "{...}"});
    let expected = Data::json(exp);
    let actual = json!({
        "people": {
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_array_start() {
    let exp = json!({
        "people": [
            "{...}",
            {
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_for_array_start_end() {
    let exp = json!([
        "{...}",
        {
            "name": "two",
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_for_array_middle_end() {
    let exp = json!([
        {
            "name": "one",
            "nickname": "1",
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_for_array_mismatch() {
    let exp = json!([
        {
            "name": "one",
            "nickname": "1",
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_bad_order() {
    let exp = json!({
        "people": ["John", "Jane"]
    });
    let expected = Data::json(exp);
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_obj_key() {
    let expected = json!({
        "[A]": "value-a",
        "[B]": "value-b",
        "[C]": "value-c",
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_with_missing_obj_key() {
    let expected = json!({
        "a": "[A]",
        "b": "[B]",
        "c": "[C]",
...
#[test]
#[cfg(feature = "json")]
fn json_normalize_redactions_glob_obj_key() {
    let expected = json!({
        "a": "value-a",
        "c": "value-c",
        "...": "{...}",
